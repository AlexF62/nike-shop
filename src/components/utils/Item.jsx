        ...
        <>
            ...
            >
                <div className={`grid items-center justify-items-center`}>
                    <h1
                        className='text-slate-200 text-lg lg:text-lg 
                    md:text-base font-medium filter drop-shadow'
                    >
                        {title}
                    </h1>
                    <p
                        className='text-slate-200 filter drop-shadow
                    ...
                    <div className='flex items-center gap-3'>
                        ...
                        <button
                            type='button'
                            className='bg-white blur-effect-theme button-theme 
